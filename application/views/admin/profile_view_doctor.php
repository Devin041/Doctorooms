					...
					<div class="box-body box-profile">
						...
						<ul class="list-group list-group-unbordered">
							<li class="list-group-item">
								<h1> <span style="font-size:15px;font-weight: bold">Rating</span> <span class="pull-right fa fa-star">  <?=$rating?>/5</span></h1>
							</li>
						</ul>
					</div>
					<!-- /.box-body -->
			...
			<div class="col-md-9">
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#timeline" data-toggle="tab">Receptionist</a></li>
					</ul>
						...
						<div class="active tab-pane" id="activity">
							...
							<div class="post">
								...
								<p>
									...
									{ ?>
										<label class="label label-default" style="font-size: 13px;"><?= $sp[$i]?></label>
								   <?php } ?>
								</p>
							</div>
