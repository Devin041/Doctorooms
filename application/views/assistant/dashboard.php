<div class="content-wrapper" style="min-height: 960px;">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <!-- /.col -->
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="<?=base_url('assistant/appointment?status='.VISITED)?>" class="info-box">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12">
                <a href="<?=base_url('assistant/post')?>" class="info-box">
            ...
            <div class="col-md-6">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Latest booked 5 approved appointment </h3>
                    </div>
                    <div class="box-body">
