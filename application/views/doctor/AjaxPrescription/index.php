                                                    ...
                                                    <input type="text" class="form-control basicAutoComplete medil"
														   ...
														   name="details[0][medicine_name]"   value="<?= $row->medicine?>" autocomplete="off" required>
																...
																<td>
																	<div class="form-group">
																		<?php
																		$allLists=json_decode($medicineAll->get_by_doctor_id_detail($user->id,$row->medicine)[0]->doz);
																...
																<td>
																<button type="button" onclick="removeItem(this)" class="btn btn-danger btn-sm"><span
...
<!--											</div>-->
					...
					<div class="tab-pane " role="tabpanel" id="complete2">
						<div class="complete2">
							<div class="step_21 content-header">
								<h1>Suggestion Details</h1><img src="<?= base_url('assets/v_.gif')?>" height="100px" id="v_on1"><img src="<?= base_url('assets/voice_off.gif')?>" height="80px" id="v_of1">
								<hr>
...
$('#v_on').hide();
    ...
    function goAppointment() {
        location.replace('<?=base_url()?>/doctor/dashboard');
    }
    function goprescription() {
        window.open("<?=base_url()?>/doctor/AjaxPrescription/print_prescription?booking_id="+booking_id+"&user_id="+user_id+"");
