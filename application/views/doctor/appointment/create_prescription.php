<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="box box-primary">
                    <?= form_open_multipart("doctor/appointment/store_prescription/".$appointment->id, array("role" => "form")) ?>
                    <div class="box-header with-border d-n">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="textarea form-control" rows="7"
                                              name="disease_description"><?php echo set_value("disease_description"); ?></textarea>
