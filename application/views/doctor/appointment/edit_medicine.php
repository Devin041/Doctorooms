<div class="content-wrapper">
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right">
                <a href="<?= base_url('doctor/appointment/show/'.$appointment->id) ?>" class="btn btn-warning">Back</a>
            </div>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="box box-primary">
                    <?= form_open_multipart("doctor/appointment/update_medicine/" . $appointment->id, array("role" => "form")) ?>
                    <div class="box-header with-border d-n">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="mytbl" class="table table-bordered">
                                    ...
                                    <?php
                                    $i = 0;
                                    foreach ($medicine_details as $detail) { ?>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <span style="position: relative;">
                                                        <input type="text" class="form-control basicAutoComplete"
                                                               ...
                                                               name="details[<?= $i ?>][medicine_name]"
                                                               value="<?= $detail->medicine_name ?>" required>
                                                    </span>
                                                </div>
                                            </td>
                                            <td>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5"
                                              name="remark"><?= $prescription->remark ?></textarea>
                                            ...
                                            <div class="form-group">
                                                <span style="position: relative;">
                                                    <input type="text" class="form-control basicAutoComplete" placeholder="Enter medicine name"
                                                           name="details[__name__][medicine_name]" required>
                                                </span>
                                            </div>
                                        </td>
                                        <td>
...
END;
            ...
            $('.basicAutoComplete').autoComplete({
                resolverSettings: {
                    url: '<?=base_url('doctor/appointment/get_branch')?>'
                }
            });
        });
        $('.basicAutoComplete').autoComplete({
