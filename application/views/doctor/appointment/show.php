    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right">
                <a href="<?= base_url('doctor/appointment') ?>" class="btn btn-warning">Back</a>
            </div>
        </h1>
    </section>
                    ...
                    <div class="box-header with-border d-n">
                        ...
                        <div class="box-tools">
							<?php if ($appointment->status == VISITED){
								?>
								<a href="<?= base_url('doctor/AjaxPrescription/print_prescription?booking_id='.$appointment->id.'&user_id='.$appointment->user_id.'')?>" class="btn btn-primary btn-sm" data-toggle="tooltip"
								   title="Print"><span class="fa fa-print"></span></a>
								<a href="<?= base_url('doctor/AjaxPrescription/create?booking_id='.$appointment->id.'&user_id='.$appointment->user_id.'') ?>"
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border d-n">
                            ...
                            <div class="box-tools">
                                <?php if (!$prescription->medicine_details && $appointment->status == APPROVE) { ?>
                                    <a href="<?= base_url('doctor/appointment/create_medicine/' . $appointment->id) ?>"
                                       class="btn btn-success btn-sm" data-toggle="tooltip"
                        ...
                        <div class="box-body">
                            ...
                            <?php if ($appointment->status == APPROVE) { ?>
                                <a href="<?= base_url('doctor/appointment/edit_prescription/' . $appointment->id) ?>"
                        ...
                        <?php if ($prescription->medicine_details) { ?>
                            <div class="box-body">
                                ...
                                <?php if ($appointment->status == APPROVE) { ?>
                                    <a href="<?= base_url('doctor/appointment/edit_medicine/' . $appointment->id) ?>"
                                       class="" data-toggle="tooltip"
