...
<div class="row">
    <div class="col-md-12">
      	<div class="box box-success">
            ...
            <?php echo form_open('doctor/label/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						<label for="label_title" class="control-label"><span class="text-danger">*</span>Label Title</label>
						<div class="form-group">
							<input type="text" name="label_title" value="<?php echo $this->input->post('label_title'); ?>" class="form-control" id="label_title" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="label_unit" value="<?php echo $this->input->post('label_unit'); ?>" class="form-control" id="label_unit" />
