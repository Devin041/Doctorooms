    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Other Setting</h3>
            </div>
            <?php echo form_open_multipart('doctor/p_other_setting/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="header" value="<?php echo $this->input->post('header'); ?>" class="form-control" id="header" />
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<br>
						<input type="radio" id="male" name="is_full_header" value="1">
						<label for="male">Full Header</label><br>
						<input type="radio" id="female" name="is_full_header" value="0">
