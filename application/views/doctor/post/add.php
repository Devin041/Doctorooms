    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right">
                <a href="<?= base_url('doctor/post') ?>" class="btn btn-danger btn-sm"><span class="fa fa-times"></span>
                        Cancel</a>
            </div>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-success">
                    ...
                    <?= form_open_multipart("doctor/post/store", array("role" => "form")) ?>
                            ...
                            <div class="col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control <?=(form_error("video_link"))?"is-invalid":""?>" name="video_link"
										   ...
										   placeholder="Enter video link (e.g. https://www.youtube.com/embed/K4DyBUG242c )" id="ytplayerSide" onclick="validateYouTubeUrl()">
