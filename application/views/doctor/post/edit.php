    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right">
                <a href="<?= base_url("doctor/post") ?>" class="btn btn-danger btn-sm"><span class="fa fa-times"></span> Cancel</a>
            </div>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-success">
                    ...
                    <?= form_open_multipart("doctor/post/update/$post->id", array("role" => "form")) ?>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="exampleInputTitle">Title</label>
                                    <input type="text" class="form-control" name="title" value="<?= (set_value("title"))?set_value("title"):$post->title ?>" id="title" placeholder="Enter Title">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="textarea form-control" rows="7" name="content"><?=(set_value("content"))?set_value("content"):$post->content ?></textarea>
