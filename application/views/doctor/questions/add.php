    ...
    <div class="col-md-12">
      	<div class="box box-success">
            <div class="box-header with-border">
              	<h3 class="box-title">Complain  Add</h3>
            </div>
            <?php echo form_open('doctor/questions/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="question_code" value="<?php echo $this->input->post('question_code'); ?>" class="form-control" id="question" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select class="form-control" name="co_id">
								...
								<option value="<?= $row['id']?>"><?= $row['co_code']?></option>
								<?php }?>
							</select>
					...
					<div class="col-md-12">
						...
						<div class="form-group">
							<textarea name="explenations" class="form-control" id="explenations"><?php echo $this->input->post('explenations'); ?></textarea>
						</div>
					</div>
				</div>
			</div>
