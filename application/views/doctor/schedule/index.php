            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title hidden">How many days before the appointment will be book?</h3>
                    </div>
                    <div class="box-body">
                        <?= form_open("doctor/schedule/update_appointment_day") ?>
                        <div class="row">
                            <div class="col-sm-6">
								<label>How many days before the appointment will be book?	</label>
							...
							<div class="col-sm-4">
								...
								<div class="form-group <?= (form_error('day_limit')) ? "has-error" : "" ?>">
									<input type="text" class="form-control" name="day_limit" placeholder="Enter day limit"
										   value="<?= $doctor->daily_limit ?>">
									<?= form_error('day_limit') ?>
								</div>
							</div>
                            <div class="col-sm-2">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    <?= form_open("doctor/schedule/delete_multi") ?>
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right">
                            ...
                            <a href="<?= base_url('doctor/schedule/create') ?>" class="btn btn-success btn-sm"><span
                        ...
                        <table class="table table-bordered dttable">
                            ...
                            foreach ($schedule as $sch) { ?>
                                <tr class="<?= (new DateTime($sch->date) < new DateTime(date("Y-m-d"))) ? "danger" : "success" ?>">
                                    ...
                                    <td><?= $sch->remark ?></td>
                                    <td>
                                        <a href="<?= base_url('doctor/schedule/delete/' . $sch->id) ?>"
