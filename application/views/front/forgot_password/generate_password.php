        ...
        <div class="container">
            <div class="row">
                <div class="col col-login mx-auto">
                    ...
                    <?= form_open('auth/generate_new_password_submit', array("class" => "card")); ?>
                    <div class="card-body p-6">
                        <div class="card-title">Create new password</div>
                        <div class="form-group">
                            <label class="form-label">New Password</label>
                            <input type="password" class="form-control" name="new_password" id="new_password"
                                   placeholder="Enter new password"
                                   value="<?php echo set_value("new_password"); ?>" autofocus>
                            <?php echo form_error('new_password'); ?>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Conform Password</label>
                            <input type="password" class="form-control" name="conform_password" id="conform_password"
                                   placeholder="Re-type password"
                                   value="<?php echo set_value("conform_password"); ?>" autofocus>
