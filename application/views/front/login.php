            ...
            <div class="row">
                <div class="col col-login mx-auto">
                    ...
                    <?php if ($this->session->flashdata('alert_msg')) { ?>
                        <div class="alert <?= $this->session->flashdata('alert_class') ?> mb-0">
                            <?= $this->session->flashdata('alert_msg') ?>
                        </div>
                    <?php } ?>
                    <?= form_open('auth/auth_login', array("class" => "card")); ?>
                    <div class="card-body p-6">
                        ...
                        <div class="form-group">
                            ...
                            <div style="color: red; font-size: 10px;"><?php echo form_error('password'); ?></div>
                        </div>
                        <div class="form-group">
                        ...
                        <a href="<?= base_url("auth/forgot_password") ?>" class="float-right small"
                           style="margin-bottom: 10px;">I forgot
                            password</a>
                    ...
                    <div class="text-center text-muted">
                        Don't have account yet? Sign up as <a href="<?= base_url("auth/register?type=dr") ?>">Doctor</a>
                        OR <a href="<?= base_url("auth/register?type=patient") ?>">Patient</a>
                    </div>
                </div>
            </div>
        </div>
