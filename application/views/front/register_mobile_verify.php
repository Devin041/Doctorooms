        ...
        <div class="container">
            <div class="row">
                <div class="col col-login mx-auto">
                    ...
                    <?php } ?>
                    <?= form_open('auth/verify_mobile_submit', array("class" => "card")); ?>
                    <div class="card-body p-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="otp" id="otp" placeholder="Enter otp"
                                   autofocus <?= ($this->session->userdata('mobile_verification_data')) ? "" : "disabled" ?>>
                        ...
                        <div class="form-footer pull-right">.
                            <?php if (!$this->session->userdata('mobile_verification_data')) { ?>
                                <a href="<?= base_url('auth/sendotp_mobile_verify') ?>"
                                   class="btn btn-default" <?= ($this->session->userdata('mobile_verification_data')) ? "disabled" : "" ?>>
                                    Send OTP
                                </a>
                            <?php } else { ?>
                                <a href="<?= base_url('auth/sendotp_mobile_verify') ?>" id="resend-otp"
                                   class="btn btn-default" <?= ($this->session->userdata('mobile_verification_data')) ? "disabled" : "" ?>>
                                    Resend OTP
                                </a>
                            <?php } ?>
                            <button type="submit"
                                    class="btn btn-primary" <?= ($this->session->userdata('mobile_verification_data')) ? "" : "disabled" ?>>
                                Submit
                            </button>
                        </div>
                    </div>
