		...
		<div class="row">
			<div class="col-sm-12">
				<div class="box box-primary">
					<?= form_open_multipart("hospital/doctor/update/$profile->user_id", array("role" => "form")) ?>
					<div class="box-body">
						<div class="row">
							<div class="col-sm-4">
								<div class="form-group">
									<label>Name</label><span class="text-red">*</span>
									<input type="text" name="name" value="<?= (set_value("name"))?set_value("name"):$profile->name ?>" class="form-control" id="name">
							...
							<div class="col-sm-4">
								<div class="form-group">
									<label>Mobile</label>
									<input type="number" value="<?= (set_value("mobile_no"))?set_value("mobile_no"):$profile->mobile_no ?>" name="mobile_no" class="form-control" id="mobile_no" disabled="disabled">
								</div>
							</div>
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select name="doctor_type" class="form-control" id="doctor_type">
										...
										foreach ($doctype as $type) { ?>
											<option <?=$type->type?> <?php if ($profile->doctor_type==$type->type) echo 'selected';?>><?=$type->type?></option>
										<?php } ?>
										?>
									</select>
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" name="fees" value="<?= (set_value("fees"))?set_value("fees"):$profile->fees ?>" class="form-control" id="fees">
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" name="contact_no" value="<?= (set_value("contact_no"))?set_value("contact_no"):$profile->contact_no ?>">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label>Latitude</label>
									<input type="text" class="form-control" name="lat" value="<?= (set_value("lat"))?set_value("lat"):$profile->lat ?>">
								</div>
							</div>
							<div class="col-sm-6">
								<div class="form-group">
									<label>Longitude</label>
									<input type="text" name="longi" class="form-control" id="longi" value="<?= (set_value("longi"))?set_value("longi"):$profile->longi ?>">
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									<label>Address</label><span class="text-red">*</span>
									<textarea name="address" class="form-control" id="address" rows="3"><?= (set_value("address"))?set_value("address"):$profile->address ?></textarea>
								...
								<div class="form-group">
									<?php foreach ($dis_name as $dis) { ?>
										<label style="margin:5px;padding: 3px;">
											...
											<input type="checkbox" name="specialization[]" value="<?=$dis->dis_name?>" <?php $ds = json_decode($profile->specialization);
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<textarea name="award_and_recognition" class="form-control"
											  id="award_and_recognition" rows="5"><?= (set_value("award_and_recognition"))?set_value("award_and_recognition"):$profile->award_and_recognition ?></textarea>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
