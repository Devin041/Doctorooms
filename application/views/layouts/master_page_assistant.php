            ...
            <div class="navbar-custom-menu">
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown notifications-menu">
                        <a href="<?= base_url("assistant/notifications") ?>" >
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="<?= base_url("assistant/notifications") ?>">View all</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?= base_url("assistant/profile") ?>" class="btn btn-default btn-flat">Profile
                                        Settings</a>
                                </div>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="<?= base_url("assistant/dashboard") ?>">
                        <i class="fa fa-dashboard"></i> <span>Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url("assistant/post") ?>">
                        <i class="fa fa-rss"></i> <span>Blog</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url("assistant/appointment") ?>">
