...
<div class="wrapper">
    ...
    <header class="main-header">
        <a href="<?=base_url('receptionist/dashboard')?>" class="logo">
                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown notifications-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="footer"><a href="<?= base_url("receptionist/notifications") ?>">View all</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?= base_url("receptionist/profile") ?>" class="btn btn-default btn-flat">Profile
                                        Settings</a>
                                </div>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="<?= base_url("receptionist/post") ?>">
                        <i class="fa fa-rss"></i> <span>Blog</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url("receptionist/appointment") ?>">
                        <i class="fa fa-check-circle"></i> <span>Appointments</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url("receptionist/schedule") ?>">
                        <i class="fa fa-clock-o"></i> <span>Manage Schedule</span>
                    </a>
                </li>
                <li>
                    <a href="<?= base_url("receptionist/medicinemaster") ?>">
                        <i class="fa fa-circle"></i> <span>Medicine list</span>
                    </a>
                </li>
            </ul>
        </section>
