        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?= form_open("receptionist/medicinemaster/edit_validate/" . $medicine->id) ?>
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                           value="<?= ($medicine->name!="") ? $medicine->name : set_value("name"); ?>"
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" value="<?= ($medicine->morning!="") ? $medicine->morning : set_value("morning"); ?>"
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" value="<?=($medicine->afternoon!="") ? $medicine->afternoon : set_value("afternoon");?>"
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" value="<?= ($medicine->evening) ? $medicine->evening : set_value("evening"); ?>"
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<select class="form-control select2Tag <?= (form_error("doz")) ? "is-invalid" : "" ?>"   name="doz[]" multiple >
										<?php
										if (count(json_decode($medicine->doz))>0){
										foreach (json_decode($medicine->doz) as $key=>$doz){
											?>
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="number" value="<?= ($medicine->tab) ? $medicine->tab : set_value("tab"); ?>"
							...
							<div class="col-sm-4">
								<div class="form-group">
									...
									<input type="text" value="<?= ($medicine->description) ? $medicine->description : set_value("description"); ?>"
