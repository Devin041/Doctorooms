    ...
    <section class="content-header">
        <h1>
            ...
            <div class="pull-right">
                <a href="<?= base_url("receptionist/post") ?>" class="btn btn-danger btn-sm"><span class="fa fa-times"></span>
                    Cancel</a>
            </div>
        </h1>
    </section>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-success">
                    ...
                    <?= form_open_multipart("receptionist/post/update/$post->id", array("role" => "form")) ?>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-12">
