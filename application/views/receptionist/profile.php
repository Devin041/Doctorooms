            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <center>
                            <?= form_open_multipart("receptionist/profile/update_profile_photo") ?>
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="info">
                            ...
                            <?= form_open("receptionist/profile/update", array("class" => "form-horizontal")) ?>
                        ...
                        <div class="tab-pane" id="chnagePass">
                            <?= form_open("receptionist/profile/change_pass", array("class" => "form-horizontal")) ?>
                            <div class="form-group">
